...
class _CouponApi implements CouponApi {
  ...
  @override
  Future<BaseResponse> checkCoupon(Map<String, dynamic> params) async {
  ...
  Future<BaseResponse> getProductDiscount({
    ...
    final _options = _setStreamType<BaseResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'discount-programs/by-product/${id}/${storeId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
