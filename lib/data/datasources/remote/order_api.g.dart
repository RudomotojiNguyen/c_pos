...
class _OrderApi implements OrderApi {
  ...
  @override
  Future<BaseResponse> getOrderDetail({required String orderId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<BaseResponse> checkUserExistOrder({required String customerId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'customer/mobile/${customerId}/check-orders',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<BaseResponse> getOrderSources({int status = 1}) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse> getOrderEnum({String? type}) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse> updateOrder(Map<String, dynamic> data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
