...
class _OrderApi implements OrderApi {
  ...
  @override
  Future<BaseResponse> getOrderDetail({required orderId}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<BaseResponse> checkUserExistOrder({required customerId}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<BaseResponse> getOrderSources({status = 1}) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse> getOrderEnum({type}) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse> createOrder(data) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse> updateOrder(data) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
