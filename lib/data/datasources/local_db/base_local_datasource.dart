...
/// used for a override function that takes inout as list of model datatype and
...
abstract class BaseLocalDataSource<TableType, ModelType> {
  ...
  /// }
  /// ```
  Future<void> insertOrUpdateItems(List<ModelType> dataSet);

  Future<Box<TableType>?> _openBox() async {
    late Box<TableType>? box;
    if (boxInstance == null) {
      _init();
    }
